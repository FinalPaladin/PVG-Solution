...
const permissionPages = [
  ...
  {
    path: adminPaths.ADMIN_AUTHORS_ROLES,
    pathIcon: <Drama className="h-5 w-5" />,
    pathName: "Vai trò",
    permissions: [hashpermission.admin_system],
    isMenu: true,
  },
  {
    path: adminPaths.ADMIN_AUTHORS_USERS,
    pathIcon: <Users className="h-5 w-5" />,
    pathName: "Người dùng",
    permissions: [hashpermission.admin_system],
    isMenu: true,
  },
  {
    path: adminPaths.ADMIN_FAQS,
    pathIcon: <FileQuestionMark className="h-5 w-5" />,
    pathName: "FAQs",
    permissions: [hashpermission.admin_system, hashpermission.admin_mkt],
    isMenu: true,
  },
  {
    path: adminPaths.ADMIN_FAQS_CREATE,
    pathIcon: null,
    pathName: "Tạo FAQs",
    permissions: [hashpermission.admin_system, hashpermission.admin_mkt],
    isMenu: false,
  ...
  {
    path: adminPaths.ADMIN_FAQS_UPDATE,
    pathIcon: null,
    pathName: "Cập nhật FAQs",
    permissions: [hashpermission.admin_system, hashpermission.admin_mkt],
    isMenu: false,
  },
] as IPageModel[];
