            ...
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <p className="text-sm md:text-base text-slate-600 max-w-xl">
                  Tận dụng giá trị sổ đỏ nhà đất để có thêm nguồn vốn cho mua
                  nhà, kinh doanh hoặc tiêu dùng, với quy trình đơn giản và rõ
                  ràng.
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-4 pt-2">
                <Button
                  ...
                  onClick={() =>
                    navigate(paths.REQUEST.replace(":idproduct", "new"))
                  }
                >
                  Đăng ký nhận tư vấn miễn phí
                </Button>
                <p className="text-xs md:text-sm text-slate-500">
                  Chuyên viên sẽ liên hệ lại để hỗ trợ chi tiết hồ sơ của
                  anh/chị.
                </p>
              </div>
