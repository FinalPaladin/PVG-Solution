...
export default function RequestCustomerPage(): JSX.Element {
  ...
  async function handleSubmit(e?: React.FormEvent) {
    ...
    try {
      ...
      if(form.age < 18)
      {
        useAlert.getState().show("Người dưới 18 tuổi không thể vay nợ.", "warning");
        return;
      }
      ...
      const payload = {
        ...
        phone: form.phone,
        productId: (idproduct == "new" || !idproduct) ? null : idproduct,
        data: data,
            ...
            <>
              <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <label className="flex flex-col gap-1">
                  ...
                  <input
                    type="date"
                    title="(Ngày tháng năm sinh trên CCCD/CMND)"
                    value={form.birthday ?? ""}
                    onChange={(e) => {onChange("birthday", e.target.value); onChange("age", today.getFullYear() - new Date(e.target.value).getFullYear());}}
                    className="h-10 rounded-md border border-gray-300 px-3 text-sm
              ...
              <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <label className="flex flex-col gap-1">
                  ...
                  <input
                    type="email"
                    value={form.email}
                    title="(Nhập email liên hệ nếu có)"
            ...
            <>
              <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <label className="flex flex-col gap-1">
                  ...
                  <input
                    type="text"
                    title="Hãy cho chúng tôi biết tổng giá trị các khoản dư nợ cho vay bạn có tại các Ngân hàng khác. Có thể bao gồm các khoản vay mua nhà - xây dựng, sửa chữa nhà,vay mua ô tô, các khoản vay cá nhân, thẻ tín dụng v.v.."
                ...
                <label className="flex flex-col gap-1 md:col-span-2">
                  ...
                  <input
                    type="text"
                    title="Hãy cho chúng tôi biết loại tài sản thế chấp mà bạn đề xuất để đảm bảo khoản vay. Đây có thể là bất động sản hoặc những tài sản có giá trị khác mà bạn đang sở hữu"
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-lg border border-gray-300
                            px-5 py-2 text-sm text-gray-700 hover:bg-gray-50"
                >
